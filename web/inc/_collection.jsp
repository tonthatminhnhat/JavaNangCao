...
<c:if test="${collection=='BC'}">
    <h3 style="margin-top: 100px;padding-left: 12%">Sản phẩm bán chạy</h3>
    <div class="khungdssp" >   
    ...
    <c:if test="${collection=='SL'}">
    <h3 style="margin-top: 100px;padding-left: 12%">Siêu Sale</h3>
    <div class="khungdssp" >   

        <c:forEach items="${listDSSP}" var="listDSSP">   
            <c:if test="${listDSSP.sale>0 &&listDSSP.hethang==false}">
                <div  class="khungsp"onclick=" window.location.href = 'http://localhost:8080/Hoadobo/ChiTietSanPham?idsp=${listDSSP.madssp}'">
...
<!--============================-->
<c:if test="${collection!='BC'&&collection!='SL'}">
    <c:forEach items="${listModel}" var="listModel">   
        <c:if test="${listModel.idmodel==collection}">
    ...
    <div class="khungdssp" >   
        ...
        <c:forEach items="${listDSSP}" var="listDSSP">   
            <c:if test="${listDSSP.hethang==false && listDSSP.idmodel==collection}">
                <div  class="khungsp"onclick=" window.location.href = 'http://localhost:8080/Hoadobo/ChiTietSanPham?idsp=${listDSSP.madssp}'">
